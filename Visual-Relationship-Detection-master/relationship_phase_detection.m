...
recall25P = top_recall_Phrase(25, rlp_confs_ours, rlp_labels_ours, sub_bboxes_ours, obj_bboxes_ours); 
recall10P = top_recall_Phrase(10, rlp_confs_ours, rlp_labels_ours, sub_bboxes_ours, obj_bboxes_ours); 
fprintf('Phrase Det. R@100: %0.2f \n', 100*recall100P);
fprintf('Phrase Det. R@50: %0.2f \n', 100*recall50P);
fprintf('Phrase Det. R@25: %0.2f \n', 100*recall25P);
fprintf('Phrase Det. R@10: %0.2f \n', 100*recall10P);
...
recall25R = top_recall_Relationship(25, rlp_confs_ours, rlp_labels_ours, sub_bboxes_ours, obj_bboxes_ours);
recall10R = top_recall_Relationship(10, rlp_confs_ours, rlp_labels_ours, sub_bboxes_ours, obj_bboxes_ours);
fprintf('Relationship Det. R@100: %0.2f \n', 100*recall100R);
fprintf('Relationship Det. R@50: %0.2f \n', 100*recall50R);
fprintf('Relationship Det. R@25: %0.2f \n', 100*recall25R);
fprintf('Relationship Det. R@10: %0.2f \n', 100*recall10R);
...
zeroShot25P = zeroShot_top_recall_Phrase(25, rlp_confs_ours, rlp_labels_ours, sub_bboxes_ours, obj_bboxes_ours);
zeroShot10P = zeroShot_top_recall_Phrase(10, rlp_confs_ours, rlp_labels_ours, sub_bboxes_ours, obj_bboxes_ours);
fprintf('zero-shot Phrase Det. R@100: %0.2f \n', 100*zeroShot100P);
fprintf('zero-shot Phrase Det. R@50: %0.2f \n', 100*zeroShot50P);
fprintf('zero-shot Phrase Det. R@25: %0.2f \n', 100*zeroShot25P);
fprintf('zero-shot Phrase Det. R@10: %0.2f \n', 100*zeroShot10P);
...
zeroShot25R = zeroShot_top_recall_Relationship(25, rlp_confs_ours, rlp_labels_ours, sub_bboxes_ours, obj_bboxes_ours);
zeroShot10R = zeroShot_top_recall_Relationship(10, rlp_confs_ours, rlp_labels_ours, sub_bboxes_ours, obj_bboxes_ours);
fprintf('zero-shot Relationship Det. R@100: %0.2f \n', 100*zeroShot100R);
fprintf('zero-shot Relationship Det. R@50: %0.2f \n', 100*zeroShot50R);
fprintf('zero-shot Relationship Det. R@25: %0.2f \n', 100*zeroShot25R);
fprintf('zero-shot Relationship Det. R@10: %0.2f \n', 100*zeroShot10R);